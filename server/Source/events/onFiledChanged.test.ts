...
describe("onFileChanged.ts", () => {
	...
	it("should handle when processFile returns a null value", () => {
		Object.defineProperty(processFile, "default", {
			value: jest.fn(() => new Promise((resolve) => resolve(null))),
		});
		return onFileChanged(components, "filePath", project).then(
			(updatedComponents: MezzuriteComponent[]) => [
	...
	it("should handle when processFile returns a component that already exists", () => {
		Object.defineProperty(processFile, "default", {
			value: jest.fn(
				() => new Promise((resolve) => resolve(components[0]))
			),
		});
		return onFileChanged(components, "filePath", project).then(
			(updatedComponents: MezzuriteComponent[]) => {
	...
	it("should handle when processFile returns a component that already exists", () => {
		...
		Object.defineProperty(processFile, "default", {
			value: jest.fn(() => new Promise((resolve) => resolve(updated))),
		});
		return onFileChanged(components, "filePath", project).then(
			(updatedComponents: MezzuriteComponent[]) => {
	...
	it("should handle when processFile returns a component that already exists", () => {
		...
		expect.assertions(1);
		return onFileChanged(components, "filePath", project).catch(
			(error: Error) => {
